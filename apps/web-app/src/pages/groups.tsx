...
export default function GroupsPage() {
    ...
    useEffect(() => {
        if (_users.length > 0) {
            setLogs(`${_users.length} voter${_users.length > 1 ? "s" : ""} retrieved from the group 🤙🏽`)
        }
    }, [_users])
    ...
    return (
        <>
            ...
            <Text pt="2" fontSize="md">
                ...
                ) here are binary incremental Merkle trees in which each leaf contains an identity commitment for a
                voter.
                <br />
                <br />
                Please enter the current voting round with your preferred name.
            </Text>
